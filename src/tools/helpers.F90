...
contains
  ...
  subroutine interpFromFaces(dx, dy, dz, i, j, k, &
    ...
    #else
      c000 = 0.25 * (fx(			i,			j,			k) + fx(			i,	j - 1,			k) + fx(			i,			j,	k - 1) + fx(			i,	j - 1,	k - 1))
      c100 = 0.25 * (fx(	i + 1,			j,			k) + fx(	i + 1,	j - 1,			k) + fx(	i + 1,			j,	k - 1) + fx(	i + 1,	j - 1,	k - 1))
      c001 = 0.25 * (fx(			i,			j,			k) + fx(			i,			j,	k + 1) + fx(			i,	j - 1,			k) + fx(			i,	j - 1,	k + 1))
      c101 = 0.25 * (fx(	i + 1,			j,			k) + fx(	i + 1,			j,	k + 1) + fx(	i + 1,	j - 1,			k) + fx(	i + 1,	j - 1,	k + 1))
      c010 = 0.25 * (fx(			i,			j,			k) + fx(			i,	j + 1,			k) + fx(			i,			j,	k - 1) + fx(			i,	j + 1,	k - 1))
      c110 = 0.25 * (fx(	i + 1,			j,			k) + fx(	i + 1,			j,	k - 1) + fx(	i + 1,	j + 1,	k - 1) + fx(	i + 1,	j + 1,			k))
      c011 = 0.25 * (fx(			i,			j,			k) + fx(			i,	j + 1,			k) + fx(			i,	j + 1,	k + 1) + fx(			i,			j,	k + 1))
      c111 = 0.25 * (fx(	i + 1,			j,			k) + fx(	i + 1,	j + 1,			k) + fx(	i + 1,	j + 1,	k + 1) + fx(	i + 1,			j,	k + 1))
      c00 = c000 * (1 - dx) + c100 * dx
      c01 = c001 * (1 - dx) + c101 * dx
      c10 = c010 * (1 - dx) + c110 * dx
      c11 = c011 * (1 - dx) + c111 * dx
    ...
    #else
      c000 = 0.25 * (fy(	i - 1,			j,	k - 1) + fy(	i - 1,			j,			k) + fy(			i,			j,	k - 1) + fy(			i,			j,			k))
      c100 = 0.25 * (fy(			i,			j,	k - 1) + fy(			i,			j,			k) + fy(	i + 1,			j,	k - 1) + fy(	i + 1,			j,			k))
      c001 = 0.25 * (fy(	i - 1,			j,			k) + fy(	i - 1,			j,	k + 1) + fy(			i,			j,			k) + fy(			i,			j,	k + 1))
      c101 = 0.25 * (fy(			i,			j,			k) + fy(			i,			j,	k + 1) + fy(	i + 1,			j,			k) + fy(	i + 1,			j,	k + 1))
      c010 = 0.25 * (fy(	i - 1,	j + 1,	k - 1) + fy(	i - 1,	j + 1,			k) + fy(			i,	j + 1,	k - 1) + fy(			i,	j + 1,			k))
      c110 = 0.25 * (fy(			i,	j + 1,	k - 1) + fy(			i,	j + 1,			k) + fy(	i + 1,	j + 1,	k - 1) + fy(	i + 1,	j + 1,			k))
      c011 = 0.25 * (fy(	i - 1,	j + 1,			k) + fy(	i - 1,	j + 1,	k + 1) + fy(			i,	j + 1,			k) + fy(			i,	j + 1,	k + 1))
      c111 = 0.25 * (fy(			i,	j + 1,			k) + fy(			i,	j + 1,	k + 1) + fy(	i + 1,	j + 1,			k) + fy(	i + 1,	j + 1,	k + 1))
      c00 = c000 * (1 - dx) + c100 * dx
      c01 = c001 * (1 - dx) + c101 * dx
      c10 = c010 * (1 - dx) + c110 * dx
      c11 = c011 * (1 - dx) + c111 * dx
    ...
    ! b_z
    #ifndef threeD
      c000 = 0.25 * (fz(	i - 1,	j - 1,			k) + fz(	i - 1,			j,			k) + fz(			i,	j - 1,			k) + fz(			i,			j,			k))
      c100 = 0.25 * (fz(			i,	j - 1,			k) + fz(			i,			j,			k) + fz(	i + 1,	j - 1,			k) + fz(	i + 1,			j,			k))
      c010 = 0.25 * (fz(	i - 1,			j,			k) + fz(	i - 1,	j + 1,			k) + fz(			i,			j,			k) + fz(			i,	j + 1,			k))
      c110 = 0.25 * (fz(			i,			j,			k) + fz(			i,	j + 1,			k) + fz(	i + 1,			j,			k) + fz(	i + 1,	j + 1,			k))
      c00 = c000 * (1 - dx) + c100 * dx
      c10 = c010 * (1 - dx) + c110 * dx
      intfz = c00 * (1 - dy) + c10 * dy
    #else
      c000 = 0.25 * (fz(	i - 1,	j - 1,			k) + fz(	i - 1,			j,			k) + fz(			i,	j - 1,			k) + fz(			i,			j,			k))
      c100 = 0.25 * (fz(			i,	j - 1,			k) + fz(			i,			j,			k) + fz(	i + 1,	j - 1,			k) + fz(	i + 1,			j,			k))
      c001 = 0.25 * (fz(	i - 1,	j - 1,	k + 1) + fz(	i - 1,			j,	k + 1) + fz(			i,	j - 1,	k + 1) + fz(			i,			j,	k + 1))
      c101 = 0.25 * (fz(			i,	j - 1,	k + 1) + fz(			i,			j,	k + 1) + fz(	i + 1,	j - 1,	k + 1) + fz(	i + 1,			j,	k + 1))
      c010 = 0.25 * (fz(	i - 1,			j,			k) + fz(	i - 1,	j + 1,			k) + fz(			i,			j,			k) + fz(			i,	j + 1,			k))
      c110 = 0.25 * (fz(			i,			j,			k) + fz(			i,	j + 1,			k) + fz(	i + 1,			j,			k) + fz(	i + 1,	j + 1,			k))
      c011 = 0.25 * (fz(	i - 1,			j,	k + 1) + fz(	i - 1,	j + 1,	k + 1) + fz(			i,			j,	k + 1) + fz(			i,	j + 1,	k + 1))
      c111 = 0.25 * (fz(			i,			j,	k + 1) + fz(			i,	j + 1,	k + 1) + fz(	i + 1,			j,	k + 1) + fz(	i + 1,	j + 1,	k + 1))
      c00 = c000 * (1 - dx) + c100 * dx
      c01 = c001 * (1 - dx) + c101 * dx
      c10 = c010 * (1 - dx) + c110 * dx
      c11 = c011 * (1 - dx) + c111 * dx
...
! subroutine interpFlds(dx, dy, dz, i, j, k, &
!                     & ex_, ey_, ez_, bx, by, bz)
...
! end subroutine
!
! subroutine interpCurrs(dx, dy, dz, i, j, k, jx0, jy0, jz0)
!   implicit none
!   integer(kind=2), intent(in) :: i, j, k
!   real, intent(in)            :: dx, dy, dz
...
!
!   ! j_x
!   c000 = 0.5 * (jx(     i,      j,      k) + jx(  i - 1,      j,      k))
!   c100 = 0.5 * (jx(     i,      j,      k) + jx(  i + 1,      j,      k))
!   c010 = 0.5 * (jx(     i,  j + 1,      k) + jx(  i - 1,  j + 1,      k))
!   c110 = 0.5 * (jx(     i,  j + 1,      k) + jx(  i + 1,  j + 1,      k))
!   c00 = c000 * (1 - dx) + c100 * dx
!   c10 = c010 * (1 - dx) + c110 * dx
!   c0 = c00 * (1 - dy) + c10 * dy
!   #ifndef threeD
!     jx0 = c0
!   #else
!     c001 = 0.5 * (jx(     i,      j,  k + 1) + jx(  i - 1,      j,  k + 1))
!     c101 = 0.5 * (jx(     i,      j,  k + 1) + jx(  i + 1,      j,  k + 1))
!     c011 = 0.5 * (jx(     i,  j + 1,  k + 1) + jx(  i - 1,  j + 1,  k + 1))
!     c111 = 0.5 * (jx(     i,  j + 1,  k + 1) + jx(  i + 1,  j + 1,  k + 1))
!     c01 = c001 * (1 - dx) + c101 * dx
!     c11 = c011 * (1 - dx) + c111 * dx
!     c1 = c01 * (1 - dy) + c11 * dy
!     jx0 = c0 * (1 - dz) + c1 * dz
...
!
!   ! j_y
!   c000 = 0.5 * (jy(     i,      j,      k) + jy(      i,  j - 1,      k))
!   c100 = 0.5 * (jy( i + 1,      j,      k) + jy(  i + 1,  j - 1,      k))
!   c010 = 0.5 * (jy(     i,      j,      k) + jy(      i,  j + 1,      k))
!   c110 = 0.5 * (jy( i + 1,      j,      k) + jy(  i + 1,  j + 1,      k))
!   c00 = c000 * (1 - dx) + c100 * dx
!   c10 = c010 * (1 - dx) + c110 * dx
!   c0 = c00 * (1 - dy) + c10 * dy
!   #ifndef threeD
!     jy0 = c0
!   #else
!     c001 = 0.5 * (jy(     i,      j,  k + 1) + jy(      i,  j - 1,  k + 1))
!     c101 = 0.5 * (jy( i + 1,      j,  k + 1) + jy(  i + 1,  j - 1,  k + 1))
!     c011 = 0.5 * (jy(     i,      j,  k + 1) + jy(      i,  j + 1,  k + 1))
!     c111 = 0.5 * (jy( i + 1,      j,  k + 1) + jy(  i + 1,  j + 1,  k + 1))
!     c01 = c001 * (1 - dx) + c101 * dx
!     c11 = c011 * (1 - dx) + c111 * dx
!     c1 = c01 * (1 - dy) + c11 * dy
!     jy0 = c0 * (1 - dz) + c1 * dz
...
!     jz0 = c00 * (1 - dy) + c10 * dy
!   #else
!     c000 = 0.5 * (jz(     i,      j,      k) + jz(      i,      j,  k - 1))
!     c100 = 0.5 * (jz( i + 1,      j,      k) + jz(  i + 1,      j,  k - 1))
!     c010 = 0.5 * (jz(     i,  j + 1,      k) + jz(      i,  j + 1,  k - 1))
!     c110 = 0.5 * (jz( i + 1,  j + 1,      k) + jz(  i + 1,  j + 1,  k - 1))
!     c001 = 0.5 * (jz(     i,      j,      k) + jz(      i,      j,  k + 1))
!     c101 = 0.5 * (jz( i + 1,      j,      k) + jz(  i + 1,      j,  k + 1))
!     c011 = 0.5 * (jz(     i,  j + 1,      k) + jz(      i,  j + 1,  k + 1))
!     c111 = 0.5 * (jz( i + 1,  j + 1,      k) + jz(  i + 1,  j + 1,  k + 1))
!     c00 = c000 * (1 - dx) + c100 * dx
!     c01 = c001 * (1 - dx) + c101 * dx
!     c10 = c010 * (1 - dx) + c110 * dx
!     c11 = c011 * (1 - dx) + c111 * dx
