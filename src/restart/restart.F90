...
#ifdef GCA
            write (UNIT_restart) species(s) % prtl_tile(ti, tj, tk) % xi_past(1:num)
            write (UNIT_restart) species(s) % prtl_tile(ti, tj, tk) % yi_past(1:num)
            write (UNIT_restart) species(s) % prtl_tile(ti, tj, tk) % zi_past(1:num)
            write (UNIT_restart) species(s) % prtl_tile(ti, tj, tk) % dx_past(1:num)
            write (UNIT_restart) species(s) % prtl_tile(ti, tj, tk) % dy_past(1:num)
            write (UNIT_restart) species(s) % prtl_tile(ti, tj, tk) % dz_past(1:num)
            write (UNIT_restart) species(s) % prtl_tile(ti, tj, tk) % u_eff(1:num)
            write (UNIT_restart) species(s) % prtl_tile(ti, tj, tk) % v_eff(1:num)
            write (UNIT_restart) species(s) % prtl_tile(ti, tj, tk) % w_eff(1:num)
            write (UNIT_restart) species(s) % prtl_tile(ti, tj, tk) % u_par(1:num)
            write (UNIT_restart) species(s) % prtl_tile(ti, tj, tk) % u_perp(1:num)
#endif
#ifdef PRTLPAYLOADS
...
#ifdef GCA
            read (UNIT_restart) species(s) % prtl_tile(ti, tj, tk) % xi_past(1:num)
            read (UNIT_restart) species(s) % prtl_tile(ti, tj, tk) % yi_past(1:num)
            read (UNIT_restart) species(s) % prtl_tile(ti, tj, tk) % zi_past(1:num)
            read (UNIT_restart) species(s) % prtl_tile(ti, tj, tk) % dx_past(1:num)
            read (UNIT_restart) species(s) % prtl_tile(ti, tj, tk) % dy_past(1:num)
            read (UNIT_restart) species(s) % prtl_tile(ti, tj, tk) % dz_past(1:num)
            read (UNIT_restart) species(s) % prtl_tile(ti, tj, tk) % u_eff(1:num)
            read (UNIT_restart) species(s) % prtl_tile(ti, tj, tk) % v_eff(1:num)
            read (UNIT_restart) species(s) % prtl_tile(ti, tj, tk) % w_eff(1:num)
            read (UNIT_restart) species(s) % prtl_tile(ti, tj, tk) % u_par(1:num)
